    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <a class="dropdown-item" href="<?php echo $_SERVER["PHP_SELF"]."?pagina=cadastraAgendaDoDentista"; ?>">Cadastrar Agenda</a>
  ...
  <div class ="container">
     ...
     case "consutarUsuarios":
		 ...
		 case"consFunc":
		  ...
		  case"cadastraAgendaDoDentista":
		 include("./cadastraAgendaDoDentista.php");
		  break;	
