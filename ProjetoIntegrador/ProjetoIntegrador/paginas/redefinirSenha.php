		 	...
		 	<hr>
		  	<div class="row">
		  		<div class="col-8" style="margin: auto">
				    ...
				    <input type="text" class="form-control" id="senha" name="senha" placeholder="Digite um senha">
				    <label for="confimaSenha">Confirma senha</label>
				    <input type="text" class="form-control" id="confimaSenha" name="confimaSenha" placeholder="Digite a senha novamente"><br>
